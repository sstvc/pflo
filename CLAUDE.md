...
`.page--project > section` 设了 `display: flow-root`,**一个 section 盒 = 一块画板,section 间隙恒为 0**,别去掉 —— 外边距一旦逃出 section 就会与相邻 section 的**合并**(取最大值),悄悄吃掉高度。达标线:带区块大标题的屏 +2px(标题上下各 1px 边框),不带的 0。
